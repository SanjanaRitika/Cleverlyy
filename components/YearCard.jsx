...
const YearCard = ({ year, highestScore, onSolveSeriouslyPress, onSolveCasuallyPress, onViewPaperPress, onViewMarkSchemePress, onViewBothPress, onViewNotesPress }) => {
  return (
    ...
    <View style={styles.card}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.seriouslyButton} onPress={onSolveSeriouslyPress}>
          <Text style={styles.buttonText}>Solve Seriously</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.casuallyButton} onPress={onSolveCasuallyPress}>
          <Text style={styles.buttonText}>Solve Casually</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.linksContainer}>
...
const styles = StyleSheet.create({
  card: {
    ...
    marginBottom: 20,
    borderWidth: .4, // or any width you prefer
    borderColor: '#7B61FF', // or any color you prefer
  },
  header: {
    flexDirection: 'row',
    justifyContent: 'space-between',
