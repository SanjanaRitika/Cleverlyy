...
const Resources = () => {
 ...
 <ScrollView style={styles.container}>
      ...
      <Text style={styles.mtitle}>All the Resources You’ll ever Need REVISION</Text>
...
{selectedCategory && selectedExam && selectedSubject && (
    <ImageBackground 
    source={require('../../assets/images/revision.png')}  // Specify the path to your image
  ...
  >
    ...
    <Link href="/pages/YearwiseQP" style={styles.navButton}>
    <Text style={styles.navButtonText}>YearwiseQP</Text>
  </Link>
